...
INCLUDEPATH += . \
  ...
  "/usr/include/libopenshot" \
  "/usr/include/libopenshot/thirdparty" \
  "/usr/include/libopenshot/include" \
  "/usr/include/libopenshot/include/Qt" \
...
LIBS += \
  ...
  -lvorbis -lmp3lame -lfaac -lvpx -lx264 -llzma -lvorbisenc \
